...
import 'package:lakuemas/features/buy_gold/data/data_sources/buy_gold_remote_data_source.dart';
...
void main() {
  ...
  late BuyGoldRemoteDataSource buyGoldRemoteDataSource;
  ...
  setUpAll(() {
    ...
    buyGoldRemoteDataSource = BuyGoldRemoteDataSource(apiService: apiService);
  });

  group(
    'buy gold remote data source checkout',
    () {
      group('Success', () {
        setUp(() {
        ...
        test(
          ...
          () async {
            ...
            final result = await buyGoldRemoteDataSource.checkout(
      ...
      group('Failed Validation', () {
        ...
        test(
          ...
          () async {
            ...
            try {
              await buyGoldRemoteDataSource.checkout(
                accessToken: 'accessToken',
                refreshToken: 'refreshToken',
                amount: 100000,
                amountType: 'nominal',
  ...
  group(
    'buy gold remote data source get balances',
    () {
      group('Success', () {
        setUp(() {
          responsepayload = jsonEncode({
        ...
        test(
          ...
          () async {
            ...
            final result = await buyGoldRemoteDataSource.getBalances(
              accessToken: 'accessToken',
              refreshToken: 'refreshToken',
            );
      ...
      group('Failed Validation', () {
        ...
        test(
          ...
          () async {
            ...
            try {
              await buyGoldRemoteDataSource.getBalances(
                accessToken: 'accessToken',
                refreshToken: 'refreshToken',
              );
            } catch (e) {
  ...
  group(
    'buy gold remote data source get price',
    () {
      group('Success', () {
        setUp(() {
          responsepayload = jsonEncode({
        ...
        test(
          ...
          () async {
            ...
            final result = await buyGoldRemoteDataSource.getPrice();
      ...
      group('Failed Validation', () {
        ...
        test(
          ...
          () async {
            ...
            try {
              await buyGoldRemoteDataSource.getPrice();
            } catch (e) {
              expect(e, isA<ClientException>());
              expect((e as ClientException).code, equals(400));
              expect((e).message, equals('The request parameter invalid'));
